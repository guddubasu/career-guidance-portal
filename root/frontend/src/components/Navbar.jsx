    ...
    <header className="navbar">
      ...
      {userData ? (
        <div className="d-flex align-items-center ms-auto gap-4">
          ...
          <Link
            className="d-flex justify-content-center align-items-center rounded-circle bg-light text-dark fw-bold text-decoration-none"
      ...
      <div className={`navbar-links ${isOpen ? "open" : ""}`}></div>
