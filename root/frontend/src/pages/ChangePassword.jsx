...
export default function Signup() {
  ...
  return (<div className="row">
    <form className="offset-3 col-5 mb-3 needs-validation" noValidate>
      ...
      {/* enter new password */}
      <div className="mb-3">
      <label htmlFor="email" className="form-label fs-5"> Enter Your Registered Email id</label>
      ...
      <div className="mb-3">
      <label htmlFor="password" className="form-label fs-5"> Confirm New Password</label>
      ...
      <button className="btn btn-outline-primary mt-3 px-5 py-2 fs-5 col-8 offset-2 mb-2">Change Password</button>
    </form>
  </div>);
}
